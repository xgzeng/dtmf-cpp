...
// y2_0
// y2_1
static void frequency_oscillator(int16_t Coeff0, int16_t Coeff1, int16_t y[],
                                 uint32_t COUNT, int32_t *y1_0, int32_t *y1_1,
  ...
  Temp1_0 = *y1_0, Temp1_1 = *y1_1, Temp2_0 = *y2_0, Temp2_1 = *y2_1,
  ...
  for (ii = 0; ii < COUNT; ++ii) {
    ...
    Temp2_0 = Temp1_0, Temp2_1 = Temp1_1;
    Temp1_0 = Temp0, Temp1_1 = Temp1, Temp0 += Temp1;
  ...
  *y1_0 = Temp1_0, *y1_1 = Temp1_1, *y2_0 = Temp2_0, *y2_1 = Temp2_1;
}
...
void DtmfGenerator::dtmfGenerating(int16_t y[]) {
  ...
  while (countLengthDialButtonsArray > 0) {
    ...
    while (tempCountDurationPushButton > 0) {
      ...
      frequency_oscillator(tempCoeff1, tempCoeff2, y, sizeOfFrame, &y1_1, &y1_2,
                           &y2_1, &y2_2);
      return;
    }
...
int32_t
DtmfGenerator::transmitNewDialButtonsArray(char dialButtonsArray[],
  ...
  if (lengthDialButtonsArray > 20)
    countLengthDialButtonsArray = 20;
